...
let first_ts: number = 123;          // integer
...
let values_ts:(string|number)[]=["Apple",2,"Orange",3,4];
//or
let values1 : Array<string|number> =["Apple",2,"Orange",3,4];
 
console.log("values:- "+values_ts);
...
// Example of a simple array in TypeScript
